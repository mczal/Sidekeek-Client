...
homeController.$inject = ['$scope',"$http","$uibModal","summaryService","searchService","$state","summaryService"];

function homeController($scope,$http,$uibModal,summaryService,searchService,$state,summaryService){
